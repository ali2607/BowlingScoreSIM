...
class Player
{
    ...
    public void Roll_1()
    {
        ...
        while (!int.TryParse(Console.ReadLine(), out score_1) || score_1 < 0 || score_1 > NumberOfPins)
        {
    ...
    public void Roll_2()
    {
        if (score_1 < NumberOfPins)
        {
            ...
            while (!int.TryParse(Console.ReadLine(), out score_2) || score_2 < 0 || score_2 + score_1 > NumberOfPins)
            {
                Console.WriteLine("Invalid input. Please enter a score between 0 and 10.");
